...
public class SchoolDaoImpl implements SchoolDao {
    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<TeacherCount> teacherCountByDept() {
        ...
        String sql = 
                    "SELECT dept, COUNT(tid) AS teacherCount "
                    + "FROM teacher "
                    + "GROUP BY dept;";
    ...
    public void addStudent() {
        ...
        String sql = "INSERT INTO student VALUES (10, 'Robert', 'Dylan');";
    ...
    public void editCourseDescription() {
        ...
        String sql = 
                    "UPDATE course SET courseDesc = 'Advanced Python with Flask' "
    ...
    public void deleteTeacher() {
        ...
        String sql = 
                    "DELETE FROM teacher WHERE tFName = 'David' "
                   + "AND tLName = 'Mitchell';";
